...
1. Check producer logs
    ```
    docker logs tf_kafka_kafka-producer_1 -f
    ```
    
    Output should be similar to:
    ```
    [main] INFO  org.lucas.kafka.producer.KafkaProducerExample - Sent (74b23319-084c-4309-80a7-c0d6f107a092, eight) to topic example @ 1525127107909.
    ```
1. Check consumer with Spark logs
    ```
    docker logs tf_kafka_kafka-consumer-spark_1 -f
    ```
...
1. Check consumer with Flink logs
    ```
    docker logs tf_kafka_kafka-consumer-flink_1 -f
    ```
